...
import { mockCategories } from '@/service/mocks/vibe-works';
...
<template>
  <!-- Published Success -->
    <div v-if="published" class="pt-32 flex flex-col items-center">
      ...
      <h2
        class="text-2xl font-700 mb-2"
        style="color: #F1F5F9; font-family: Orbitron, sans-serif"
      >
        发布成功!
      </h2>
          ...
          <div class="flex flex-wrap gap-2">
            <button
              ...
              :style="{
                ...
                background: form.category === cat.id ? 'rgba(249, 115, 22, 0.12)' : 'rgba(30, 41, 59, 0.5)',
