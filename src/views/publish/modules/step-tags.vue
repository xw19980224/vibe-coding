    ...
    <div>
      ...
      <div class="flex items-center gap-2 mb-3">
        <input
          ...
          class="flex-1 h-10 px-4 rounded-lg text-sm outline-none transition-all duration-200 text-slate-100 font-mono bg-slate-800/50 border border-orange-500/10"
